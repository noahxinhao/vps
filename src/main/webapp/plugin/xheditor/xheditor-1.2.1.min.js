...
(function () {
    ...
    e.mapLang = {}, e.setLang = function (i, s) {
        s === t && (s = i, i = ""), "" !== i && (i += ".");
        var a, n;
        for (var o in s)n = s[o], a = i + o, "string" == typeof n || n instanceof Array ? e.mapLang[a] = n : e.setLang(a, n)
    ...
    var specialKeys = {27: "esc", 9: "tab", 32: "space", 13: "enter", 8: "backspace", 145: "scroll", 20: "capslock", 144: "numlock", 19: "pause", 45: "insert", 36: "home", 46: "del", 35: "end", 33: "pageup", 34: "pagedown", 37: "left", 38: "up", 39: "right", 40: "down", 112: "f1", 113: "f2", 114: "f3", 115: "f4", 116: "f5", 117: "f6", 118: "f7", 119: "f8", 120: "f9", 121: "f10", 122: "f11", 123: "f12"}, arrAlign = [
        {v: "justifyleft"},
        {v: "justifycenter"},
        {v: "justifyright"},
        {v: "justifyfull"}
    ...
    var arrDbClick = {a: "Link", img: "Img", embed: "Embed"}, uploadInputname = "filedata", arrEntities = {"<": "&lt;", ">": "&gt;", '"': "&quot;", "\u00ae": "&reg;", "\u00a9": "&copy;"}, regEntities = /[<>"\u00ae\u00a9]/g, Xheditor = function (textarea, options) {
        ...
        function checkShortcuts(e) {
            ...
            for (a in n) {
                if (a = n[a], !$.isFunction(a))return _this.exec(a), !1;
        ...
        function getLocalUrl(e, t, i) {
            ...
            if ("" === l && (l = "80"), "" === r ? r = "/" : "/" !== r.charAt(0) && (r = "/" + r), e = $.trim(e), "abs" !== t && (e = e.replace(RegExp(a + "\\/\\/" + o.replace(/\./g, "\\.") + "(?::" + l + ")" + ("80" === l ? "?" : "") + "(/|$)", "i"), "/")), "rel" === t && (e = e.replace(RegExp("^" + r.replace(/([\/\.\+\[\]\(\)])/g, "\\$1"), "i"), "")), "rel" !== t && (e.match(/^(https?:\/\/|\/)/i) || (e = r + e), "/" === e.charAt(0))) {
                ...
                for (c = 0; p > c; c++)h = u[c], ".." === h ? d.pop() : "" !== h && "." !== h && d.push(h);
        ...
        this.init = function () {
            ...
            $.each(settings.tools, function (e, t) {
                if (t.match(r) && l.push('<span class="xheGEnd"/>'), "|" === t)l.push('<span class="xheSeparator"/>'); else if ("/" === t)l.push("<br />"); else {
            ...
            if (h)if (is(h, "array"))for (var c in h)headHTML += '<link rel="stylesheet" href="' + h[c] + '"/>'; else headHTML += h.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i) ? h : '<link rel="stylesheet" href="' + h + '"/>';
            ...
            setTimeout(setOpts, 300), _this.setSource(), _win.setInterval = null, _jTools.append(getLang(l.join(""))).bind("mousedown contextmenu", returnFalse).click(function (e) {
                ...
                if (s && s > 10)return bDisableHoverExec = !0, setTimeout(function () {
                    bDisableHoverExec = !1
                }, 100), !1;
                ...
                var t = e.which;
                if (27 == t)_jTools.find("a").attr("tabindex", "-1"), _this.focus(); else if (e.altKey && t >= 49 && 57 >= t)return _jTools.find(".xheGStart").eq(t - 49).next().find("a").focus(), !1
            });
            ...
            isOpera ? p.bind("keydown", function (e) {
                ...
                if (s && (i = s.files) && i.length > 0) {
                    ...
                    for (a in l)n = l[a], settings["up" + n + "Url"] && settings["up" + n + "Url"].match(/^[^!].*/i) && r.push(n + ":," + settings["up" + n + "Ext"]);
                    return 0 === r.length ? !1 : (o = r.join(","), n = t(i), 1 === n ? alert(getLang("upload.extLimit", o.replace(/\w+:,/g, ""))) : 2 === n ? alert(getLang("upload.typeLimit")) : n && _this.startUpload(i, settings["up" + n + "Url"], "*", function (e) {
                        ...
                        s && s(e);
                        for (var a = 0, o = e.length; o > a; a++)t = e[a], url = is(t, "string") ? t : t.url, "!" === url.substr(0, 1) && (url = url.substr(1)), i.push(url);
            ...
            if (isIE)t.moveToElementText(i); else {
                for (var s = e ? "lastChild" : "firstChild"; 3 != i.nodeType && i[s];)i = i[s];
                t.selectNode(i)
            }
            if (t.collapse(e ? !1 : !0), isIE)t.select(); else {
                var a = _this.getSel();
            ...
            } else"control" === i.type.toLowerCase() && (i.clear(), s = _this.getRng()), s.pasteHTML(e);
            ...
            function i(e, t, i, s, a, n) {
                var o, l, r, h, c = "";
                if (o = s.match(/font-family\s*:\s*([^;"]+)/i), o && (c += ' face="' + o[1] + '"'), l = s.match(/font-size\s*:\s*([^;"]+)/i)) {
                    l = l[1].toLowerCase();
                    for (var d = 0; arrFontsize.length > d; d++)if (l === arrFontsize[d].n || l === arrFontsize[d].s) {
                        r = d + 1;
                        break
                    }
                    r && (c += ' size="' + r + '"', s = s.replace(/(^|;)(\s*font-size\s*:\s*[^;"]+;?)+/gi, "$1"))
                }
                if (h = s.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)) {
                    var u;
                    if (u = h[1].match(/\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i)) {
                        h[1] = "#";
                        for (var p = 1; 3 >= p; p++)h[1] += ("0" + (u[p] - 0).toString(16)).slice(-2)
                    }
                    h[1] = h[1].replace(/^#([0-9a-f])([0-9a-f])([0-9a-f])$/i, "#$1$1$2$2$3$3"), c += ' color="' + h[1] + '"'
                }
                return s = s.replace(/(^|;)(\s*(font-family|color)\s*:\s*[^;"]+;?)+/gi, "$1"), "" !== c ? (s && (c += ' style="' + s + '"'), "<font" + (i ? i : "") + c + (a ? a : "") + ">" + n + "</font>") : e
            }

            function s(e, t, i, s, a) {
                for (var o, l, r = (i ? i : "") + (s ? s : ""), h = [], c = [], d = 0; n.length > d; d++)o = n[d].r, l = n[d].t, r = r.replace(o, function () {
            ...
            if ("write" === t)e = e.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function (e, t, i, s, n, o, l) {
                ...
                var r, h = "";
                if ("del" === s)s = "strike"; else if ("img" === s)n = n.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (e, t) {
                    return r = t.match(/^(["']?)(.*)\1/)[2], r = r.split(","), r[1] || (r[1] = r[0], r[0] = ""), "default" === r[0] && (r[0] = ""), settings.emotMark ? e : ""
                }); else if ("a" === s)!n.match(/ href=[^ ]/i) && n.match(/ name=[^ ]/i) && (h += " xhe-anchor"), l && (o = "></a>"); else if ("table" === s && !i) {
                ...
                if (isWebkit)for (var n = [
                    {r: /font-weight\s*:\s*bold;?/gi, t: "strong"},
                    {r: /font-style\s*:\s*italic;?/gi, t: "em"},
                    {r: /text-decoration\s*:\s*underline;?/gi, t: "u"},
                    {r: /text-decoration\s*:\s*line-through;?/gi, t: "strike"}
                ], o = 0; 2 > o; o++)e = e.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/gi, s), e = e.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/gi, s), e = e.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/gi, s);
                e = e.replace(/(<(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/g, function (e, t, i, s, a) {
                    i = i.toLowerCase();
                    var n;
                    return s = s.replace(/\s+_xhe_(?:src|href)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (e, t) {
                        return n = t.match(/^(["']?)(.*)\1/)[2], ""
                    }), n && urlType && (n = getLocalUrl(n, urlType, urlBase)), s = s.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g, function (e, t, i) {
                        if (t = t.toLowerCase(), i = i.match(/^(["']?)(.*)\1/)[2].replace(/"/g, "'"), "class" === t) {
                            ...
                            if (n && t.match(/^(src|href)$/i))return" " + t + '="' + n + '"';
                            "style" === t && (i = i.replace(/(^|;)\s*(font-size)\s*:\s*([a-z-]+)\s*(;|$)/i, function (e, t, i, s, a) {
                                for (var n, o, l = 0; arrFontsize.length > l; l++)if (n = arrFontsize[l], s === n.n) {
                                    o = n.s;
                                    break
                                }
                                return t + i + ":" + o + a
            ...
            if (i > 0 && 3 > i && /mso(-|normal)|WordDocument|<table\s+[^>]*?x:str|\s+class\s*=\s*"?xl[67]\d"/i.test(e)) {
                e = e.replace(/<!--[\s\S]*?-->|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/gi, ""), e = e.replace(/\r?\n/gi, ""), isIE ? (e = e.replace(/<v:shapetype(\s+[^>]*)?>[\s\S]*<\/v:shapetype>/gi, ""), e = e.replace(/<v:shape(\s+[^>]+)?>[\s\S]*?<v:imagedata(\s+[^>]+)?>\s*<\/v:imagedata>[\s\S]*?<\/v:shape>/gi, function (e, t, i) {
                    ...
                    return a = a.toLowerCase(), a.match(/^(link)$/) && n.match(/file:\/\//i) || a.match(/:/) || "span" === a && 2 === i ? "" : (s || (n = n.replace(/\s([\w\-:]+)(?:\s*=\s*("[^"]*"|'[^']*'|[^>\s]+))?/gi, function (e, t, s) {
                        ...
                        if (s = s.match(/^(["']?)(.*)\1/)[2], 1 === i)switch (a) {
                            case"p":
                                if ("style" === t)return s = s.replace(/"|&quot;/gi, "'").replace(/\s*([^:]+)\s*:\s*(.*?)(;|$)/gi,function (e, t, i) {
                ...
                for (var s = 0; 3 > s; s++)e = e.replace(/<font(\s+[^>]+)><font(\s+[^>]+)>/gi, function (e, t, i) {
                    return"<font" + t + i + ">"
                });
            ...
            function i(e) {
                for (var t = {}, i = e.split(","), s = 0; i.length > s; s++)t[i[s]] = !0;
                return t
            }
            ...
            function n(e) {
                if (e)for (var t = y.length - 1; t >= 0 && y[t] !== e; t--); else var t = 0;
                if (t >= 0) {
            ...
            function h(e, i, s) {
                if (P || (e = e.replace(/(\t*\r?\n\t*)+/g, "")), P || t !== !0)w.push(e); else {
                    if (e.match(/^\s*$/))return w.push(e), undefined;
                    var a = p[i], n = a ? i : "";
            ...
            function d(e, t, i, s) {
                ...
                return i = i.replace(/ face\s*=\s*"\s*([^"]*)\s*"/i, function (e, t) {
                    ...
                    return a += "font-size:" + arrFontsize[(t > 7 ? 7 : 1 > t ? 1 : t) - 1].s + ";", ""
            ...
            for (var k, C, T, S, $, F, L, j = 0, M = -1, E = "body", P = !1; k = x.exec(e);)C = k.index, C > j && (F = e.substring(j, C), S ? $.push(F) : o(F)), j = x.lastIndex, !(T = k[1]) || (T = s(T), S && T === S && (l($.join("")), S = null, $ = null), S) ? S ? $.push(k[0]) : (T = k[3]) ? (T = s(T), a(T, k[4], k[5]), v[T] && (S = T, $ = [])) : k[2] && r(k[0]) : n(T);
            return e.length > j && o(e.substring(j, e.length)), n(), e = w.join(""), w = null, e = e.replace(/<(font)(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/gi, d), e = e.replace(/<(font)(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/gi, d), e = e.replace(/<(font)(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/gi, d), e = e.replace(/^(\s*\r?\n)+|(\s*\r?\n)+$/g, "")
            ...
            if (i && a.find("#xheLinkAnchor").change(function () {
                ...
                if (!n.attr("href"))return ev = null, _this.exec("Anchor");
            ...
            settings.upLinkUrl && _this.uploadInit(l, settings.upLinkUrl, settings.upLinkExt), h.click(function () {
                ...
                if (("" === e || 0 === n.length) && _this._exec("unlink"), "" !== e && "http://" !== e) {
                    ...
                    if (t.length > 1) {
                        ...
                        for (var u = 0, p = t.length; p > u; u++)e = t[u], "" !== e && (e = e.split("||"), a = h, a = a.replace("xhe_tmpurl", e[0]), a = a.replace("xhe_tmptext", e[1] ? e[1] : s), d.push(a));
                        _this.pasteHTML(d.join("&nbsp;"))
                    } else e = t[0].split("||"), s || (s = e[0]), s = e[1] ? e[1] : "" !== c ? "" : s ? s : e[0], 0 === n.length ? (s ? _this.pasteHTML('<a href="#xhe_tmpurl">' + s + "</a>") : _this._exec("createlink", "#xhe_tmpurl"), n = $('a[href$="#xhe_tmpurl"]', _doc)) : s && !isWebkit && n.text(s), xheAttr(n, "href", e[0]), "" !== i ? n.attr("target", i) : n.removeAttr("target")
                }
            ...
            if (1 === t.length) {
                if (t.attr("href"))return ev = null, _this.exec("Link");
                i.val(t.attr("name"))
            }
            s.click(function () {
                _this.loadBookmark();
            ...
            settings.upImgUrl && _this.uploadInit(i, settings.upImgUrl, settings.upImgExt), c.click(function () {
                ...
                if ("" !== e && "http://" !== e) {
                    ...
                    if (c.length > 1) {
                        ...
                        for (var w in c)e = c[w], "" !== e && (e = e.split("||"), b = x, b = b.replace("xhe_tmpurl", e[0]), e[1] && (b = '<a href="' + e[1] + '" target="_blank">' + b + "</a>"), _.push(b));
            ...
            n && _this.uploadInit(h, n, o), 1 === r.length && (h.val(xheAttr(r, "src")), c.val(r.attr("width")), d.val(r.attr("height"))), u.click(function () {
                ...
                if ("" !== e && "http://" !== e) {
                    ...
                    if (u.length > 1) {
                        ...
                        for (var m in u)e = u[m].split("||"), p = g, p = p.replace("xhe_tmpurl", e[0]), p = p.replace("xhe_width", e[1] ? e[1] : t), p = p.replace("xhe_height", e[2] ? e[2] : n), "" !== e && f.push(p);
            ...
            if (c)for (var u = 1; c >= u; u++)a++, n.push("<a href=\"javascript:void('" + u + '\')" style="background-image:url(' + s + u + '.gif);" emot="' + e + "," + u + '" xhev="" title="' + u + '" role="option">&nbsp;</a>'), 0 === a % h && n.push("<br />"); else {
                var p = is(d, "array");
                $.each(d, function (t, i) {
            ...
            m >= f && (m = ""), o = $(getLang("<style>" + (m ? ".xheEmot div{width:" + (g + 20) + "px;height:" + m + "px;}" : "") + ".xheEmot div a{width:" + l + "px;height:" + r + "px;}</style><div>" + n.join("") + "</div>")).click(function (e) {
                e = e.target;
                var t = $(e);
                if ($.nodeName(e, "A"))return _this.loadBookmark(), _this.pasteHTML('<img emot="' + t.attr("emot") + '" alt="' + t.attr("xhev") + '">'), _this.hidePanel(), !1
            ...
            function s(t) {
                ...
                for (r && r(t), i = 0; o > i; i++)s = t[i], a = is(s, "string") ? s : s.url, "!" === a.substr(0, 1) && (n = !0, a = a.substr(1)), l.push(a);
            ...
            if (!isOpera && bHtml5Upload && (!fromFiles.nodeType || (fileList = fromFiles.files) && fileList[0].name)) {
                ...
                if (len > upMultiple)return alert(getLang("upload.countLimit", upMultiple)), undefined;
            ...
            function callbackModal(e) {
                modalWin.document.write(""), _this.removeModal(), null != e && callback(e)
            }
            ...
            if (t.e)t.e.call(_this); else switch (e = e.toLowerCase()) {
                case"cut":
                    try {
