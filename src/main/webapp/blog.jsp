...
<jsp:include page="head.jsp"/>
     <div class="container">
         ...
         <div class="row">
             <div class="col-md-9">
                 <div class="row">
                     <div class="panel panel-default im-panel  col-md-12">
                         <div class="panel-heading im-panel-header clearfix">
                                 <img class="img-circle " alt="why520crazy" src="http://tp3.sinaimg.cn/2530282462/180/5669530341/1"/>
