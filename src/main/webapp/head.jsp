    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <strong>IMDOU8<small style="line-height: 8px">™</small></strong>
            </a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/home#/vpsDetail"><span class="glyphicon glyphicon-download-alt"></span> 资源下载</a></li>
                        <li><a href="/home#/vpsDetail"><span class="glyphicon glyphicon-folder-open"></span> 实例DEMO</a></li>
                        <li class="divider"></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:if test="${sysUser!=null}">
                    <ul class="nav navbar-nav ">
                        <li class="dropdown">
                            <a href="/home" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> &nbsp;${sysUser.real_name}&nbsp; <span class="caret"></span></a>
