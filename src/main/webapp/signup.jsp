            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <%--<div class="panel-body" ng-app="signup">
                            <form role="form" class="im-editor" ng-controller="verifyForm">
                                <div class="form-group">
                                    <label for="exampleInputaccount1">邮箱/手机号码</label><span class="pull-right has-error">手机号码错误</span>
                                    <input type="account" class="form-control" id="exampleInputaccount1" placeholder="请输入邮箱或手机号码">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-body" ng-controller="signupController">
                            <form role="form" class="im-editor" name="signupForm" novalidate ng-submit="submitForm()">
                                <div class="form-group" ng-class="{true: 'form-group has-error', false: 'form-group'}[signupForm.account.$invalid && submitted]">
                                    <label for="Inputaccount1">邮箱/手机号码</label>
                                    <span class="pull-right"
                                          ng-show="signupForm.account.$dirty && signupForm.account.$invalid&& submitted">
                                        <small ng-show="signupForm.account.$error.required">请输入邮箱或手机号码</small>
                                        <small ng-show="signupForm.account.$error.minlength">请输入6~15位字符</small>
                                        <small ng-show="signupForm.account.$error.maxlength">请输入6~15位字符</small>
                                        <small ng-show="signupForm.account.$invalid">请输入正确格式的邮箱地址或手机号码</small>
                                    </span>
                                    <input type="text"
                                           ...
                                           ng-pattern = "/^[-_A-Za-z0-9]+@([_A-Za-z0-9]+\.)+[A-Za-z0-9]{2,3}$|(13[0-9]{9}$)|(14[5-7]{9}$)|(15[0-9]{9}$)|(18[0-9]{9}$)/"
                                           id="Inputaccount1"
                                           class="form-control"/>
                                </div>
                                <div class="form-group" ng-class="{true: 'form-group has-error', false: 'form-group'}[(signupForm.userpassword.$invalid && submitted)||accountUsed]">
                                    ...
                                    <span class="pull-right"
                                        ...
                                        <small ng-show="accountUsed">用户名已注册</small>
                                    </span>
                                    <input type="password"
